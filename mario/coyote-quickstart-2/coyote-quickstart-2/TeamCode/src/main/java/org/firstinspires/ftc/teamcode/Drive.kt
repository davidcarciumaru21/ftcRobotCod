...
class MecanumDrive(hardwareMap: HardwareMap) : IDriveController {
    ...
    fun applyVelocity(velRobot1: Twist2dDual) {
        var velRobot = Twist2dDual(velRobot1.trVelocity, -velRobot1.rotVelocity)
        ...
        motorBL.power = 0.7 * vCompFeedForwardDual(v.backLeft, voltage)
